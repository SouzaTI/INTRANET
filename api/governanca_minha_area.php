<?php
// Governança Minha Área v5 - consulta + gestão + cadastros atuais
...
<!-- GOVERNANCA_MINHA_AREA_V5_CADASTROS_ATUAIS -->
...
(() => {
    ...
    function renderCurrentRegistrations(code,data){
        ...
        return `
            <div class="gov-current-section" data-cadastros-atuais="${esc(code)}">
